...
@Test(timeout = 4000)
 public void test09()  throws Throwable  {
   Appt appt2 = new Appt(1, 1, 1, 1, 2000, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
   appt2.setValid();
...
@Test(timeout = 4000)
 public void test10()  throws Throwable  {
   Appt appt2 = new Appt(0, 40, 14, 1, 2000, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
   appt2.setValid();
...
@Test(timeout = 4000)
 public void test11()  throws Throwable  {
   Appt appt2 = new Appt(0, 0, 1, 1, 2000, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
   appt2.setValid();
   assertTrue(appt2.getValid());
   //assertEquals(appt2.isOn(9,11,2018), true);
}
...
@Test(timeout = 4000)
 public void test12()  throws Throwable  {
   Appt appt2 = new Appt(23, 59, 31, 12, 2000, "Birthday Party", "This is my birthday party", "xyz@gmail.com");
   appt2.setValid();
   assertTrue(appt2.getValid());
   //assertEquals(appt2.isOn(9,11,2018), true);
}
